...
export const PostCard = ({ post }: PostCardProps) => {
  ...
  return (
    <Link href={`/${post.slug}`}>
      <article className="block p-6 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-lg shadow-sm hover:shadow-md hover:scale-105 duration-200 cursor-pointer">
